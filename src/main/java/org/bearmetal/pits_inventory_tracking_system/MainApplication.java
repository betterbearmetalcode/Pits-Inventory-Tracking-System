...
public class MainApplication extends Application {
    ...
    public void start(Stage stage) throws IOException, SQLException {
        ...
        try{
            ...
            tables.put("items", "item_id INTEGER PRIMARY KEY, item_name TEXT, item_description TEXT, item_quantity INTEGER, item_available INTEGER, item_vendor TEXT, item_part_number TEXT, item_info TEXT, packed INTEGER, location_id INTEGER, photo_path TEXT");
            ...
            DataImporter.importFromFile(new File("testData.csv"));
            ...
            Scene scene = new Scene(initialSceneLoader.load(), ApplicationVars.windowWidth, ApplicationVars.windowHeight);
